...
function makeApprovalDatabase(initialStatus="approved") {
  const state={approval_id:"approval-1",organization_id:"org-1",agent_id:"agent-1",requested_action:"send_notification",status:initialStatus,executed_result:null};
  return {
    state,
    database:{
...
const context={organizationId:"org-1",userId:"approver-1"};
