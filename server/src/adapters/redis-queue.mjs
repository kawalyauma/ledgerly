...
export class RedisQueue {
  constructor({ client, name = "default", namespace = "ledgerly:jobs", maxAttempts = 5 }) {
  ...
  async enqueue(job) {
    ...
    await this.client.lPush(this.keys.ready, JSON.stringify(valid));
    return { jobId: valid.jobId, queued: true };
  }
