import { createAcademicsParityService } from '../academics/parity-service.mjs';
...
export default{
  ...
  async create({services,extensionConfig}){
    const api=createAcademicsParityService({database:services.database,audit:services.audit});
    return{
