...
export const BUSINESS_ROUTE_AUTHORITY_POLICY=Object.freeze({
  'school-setup':Object.freeze({capability:'school.reference.write'}),
...
export function createHttpCutoverCapabilities(config,overrides={}){
  ...
  const schoolSetup=normalizeMode(school.setupCutover);
  ...
  return createCutoverCapabilities({
    'school.reference.read':schoolSetup,
    'school.reference.write':schoolSetup,
