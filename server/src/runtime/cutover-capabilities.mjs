...
const defaults=Object.freeze({
  ...
  'finance.reference.read':'cloudflare','finance.documents.write':'cloudflare','finance.payments.write':'cloudflare','finance.journals.write':'cloudflare','finance.reversals.write':'cloudflare','finance.approvals.write':'cloudflare','finance.reports.read':'cloudflare','finance.dashboard.read':'cloudflare',
