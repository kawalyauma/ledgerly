...
const TOOL_META=Object.freeze({
 ...
 get_staff:{description:"Find staff in the current organization by ID, staff number or name.",parameters:object({query:string("Staff ID, staff number or name."),limit:integer("Maximum results.",1,50)})},
 get_school_profile:{description:"Read the current organization's school profile.",parameters:object()},
 get_academic_context:{description:"Read academic years, terms, classes and subjects for planning academic work.",parameters:object({academicYearId:string("Optional academic year ID."),termId:string("Optional term ID.")})},
