...
export async function createAiWorkforce({ services, config = {}, businessTools = {}, embedder = null, logger = console }) {
  ...
  return Object.freeze({ providerRegistry, store, storeCapabilities, agents, tasks:taskService, approvals:approvalService, documents, memory, knowledge, schedules, gateway, worker, health, close, config:{providerConfig,limits} });
}
