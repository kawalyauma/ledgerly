...
type Route="home"|"attendance"|"school"|"academics"|"exams"|"books";
export default function App(){
  ...
  return <HomeScreen session={session} onAttendance={()=>{setAttendanceView("landing");setRoute("attendance")}} onSchool={()=>setRoute("school")} onAcademics={()=>setRoute("academics")} onExams={()=>setRoute("exams")} onBooks={()=>setRoute("books")} onLogout={requestLogout}/>;
}
