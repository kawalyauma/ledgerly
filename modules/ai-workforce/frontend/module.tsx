...
const routes={...Object.fromEntries(paths.map((section)=>[`ai-workforce/${section}`,{scope:"ai:read",view:AiWorkforceMainWorkspace}])),"ai-workforce/documents":{scope:"ai:read",view:AiDocumentsMainWorkspace}};
