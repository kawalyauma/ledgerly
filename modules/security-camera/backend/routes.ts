...
securityCameraRoutes.get("/manifest",c=>c.json({data:{key:"security-camera",name:"Security Cameras",version:"0.6.0",cameraProtocol:"4",capabilities:["qr-pairing","nvr-pairing","whip-publish","whep-live-view","nvr-recording","lan-segment-fallback","recording-sync","device-health","appliance-mode","archive-timeline","playback-grants","clip-export","camera-profiles","multi-volume-storage","operational-alerts"]}}));
