...
securityCameraRoutes.get("/manifest",c=>c.json({data:{key:"security-camera",name:"Security Cameras",version:"0.5.0",cameraProtocol:"3",capabilities:["qr-pairing","nvr-pairing","whip-publish","whep-live-view","nvr-recording","lan-segment-fallback","recording-sync","device-health","appliance-mode"]}}));
