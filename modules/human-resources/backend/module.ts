...
export const moduleDefinition: BackendModuleDefinition = {
  ...
  order:22,
  routes:[
    {basePath:"/api/v1/human-resources",router:humanResourcesRoutes},
    {basePath:"/api/v1/human-resources",router:humanResourcesOnboardingWorkflowRoutes},
    {basePath:"/api/v1/human-resources",router:humanResourcesAdminWorkflowRoutes},
    {basePath:"/api/v1/human-resources",router:humanResourcesAuditWorkflowRoutes},
  ],
};
