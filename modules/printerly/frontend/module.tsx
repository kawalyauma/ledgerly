...
const moduleDefinition:FrontendModuleDefinition={
  key:"printerly",name:"Printerly",version:"1.4.0",order:42,
  routes:{printerly:{view:PrinterlyWorkspace},"printerly-operations":{view:PrinterlyOperationsWorkspace},"printerly-reports":{view:PrinterlyReportsWorkspace},"printerly-quotas":{view:PrinterlyQuotaWorkspace,admin:true}},
  navigation:[{label:"Printerly",icon:Printer,order:42,items:[{label:"Print Center",path:"printerly"},{label:"Operations & Scannerly",path:"printerly-operations"},{label:"Usage Reports",path:"printerly-reports"},{label:"Quotas & Governance",path:"printerly-quotas",admin:true}]}],
  globalActions:[
