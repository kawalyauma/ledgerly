...
const moduleDefinition:FrontendModuleDefinition={key:"printerly",name:"Printerly",version:"1.8.0",order:42,routes:{printerly:{view:PrinterlyWorkspace},"printerly-operations":{view:PrinterlyOperationsWorkspace},"printerly-reports":{view:PrinterlyReportsWorkspace},"printerly-quotas":{view:PrinterlyQuotaWorkspace,admin:true},"printerly-rules":{view:PrinterlyRulesWorkspace},"printerly-batches":{view:PrinterlyBatchesWorkspace},"printerly-audit":{view:PrinterlyAuditWorkspace},"printerly-routing":{view:PrinterlyRoutingWorkspace,admin:true}},navigation:[{label:"Printerly",icon:Printer,order:42,items:[{label:"Print Center",path:"printerly"},{label:"Operations & Scannerly",path:"printerly-operations"},{label:"Usage Reports",path:"printerly-reports"},{label:"Quotas & Governance",path:"printerly-quotas",admin:true},{label:"Rules & Approvals",path:"printerly-rules"},{label:"Schedules & Batches",path:"printerly-batches"},{label:"Audit & Compliance",path:"printerly-audit"},{label:"Printer Pools & Routing",path:"printerly-routing",admin:true}]}],globalActions:[{key:"printerly-global-print",label:"Print with Printerly",order:42,component:PrintWithPrinterlyAction},{key:"printerly-global-scannerly",label:"Scannerly",order:43,component:ScannerlyInboxAction}]};export default moduleDefinition;
